...
**STEP 1:** Enter the directory you have downloaded the BAM and TAIR files and run ScanExitronLR with the following command:
    ...
    selr extract -i ara_example_1.bam -g TAIR10.fas -r TAIR10_GFF3_sorted.gff.gz --ao 1 --pso 0.05 -sa -arabidopsis
...
Run the same command for the second example:
    ...
    selr extract -i ara_example_2.bam -g TAIR10.fas -r TAIR10_GFF3_sorted.gff.gz --ao 1 --pso 0.05 -sa -arabidopsis
